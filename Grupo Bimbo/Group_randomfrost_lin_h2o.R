...
print(paste("Model: Product Groups & randomForest",Sys.time()))
...
## 训练 randomForest; 使用参数以保持整体运行时间在20分钟内
...
h2o.exportFile(submissionFrame,path="sh2o_rf.csv")  ## 输出文件
